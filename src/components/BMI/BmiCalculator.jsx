...
function BmiCalculator() {
    ...
    return (
        <>
                ...
                <div
                    ...
                    <div className="row d-flex justify-content-evenly m-0">
                        ...
                        >
                            <div className="d-flex">
                                <div className="heightDiv">
                                    <h3 className="text-white mb-2 fs-5">WEIGHT</h3>
                                </div>
                                ...
                                <div className="dropdown p-0">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-dark">
                                        <li><button className="dropdown-item btn active" id="cmBtn" style={{ border: "none", backgroundColor: "transparent", color: "white" }} onClick={() => { setkg(true) && setPounds(false) }}>kg</button></li>
                                        <li><button className="dropdown-item" id="inchBtn" style={{ border: "none", backgroundColor: "transparent", color: "white" }} onClick={() => { setPounds(true) && setkg(false) }}>pound</button></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        >
                            <div className="d-flex">
                                <div className="heightDiv">
                                    <h3 className="text-white mb-2 fs-5">HEIGHT</h3>
                                </div>
                                ...
                                <div className="dropdown p-0">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-dark">
                                        <li><button className="dropdown-item btn active" id="cmBtn" style={{ border: "none", backgroundColor: "transparent", color: "white" }} onClick={() => { setCm(true) && setFoot(false) && setInch(false) }}>cm</button></li>
                                        <li><button className="dropdown-item" id="inchBtn" style={{ border: "none", backgroundColor: "transparent", color: "white" }} onClick={() => { setInch(true) && setCm(false) && setFoot(false) }}>inch</button></li>
                                        <li><button className="dropdown-item" id="footBtn" style={{ border: "none", backgroundColor: "transparent", color: "white" }} onClick={() => { setFoot(true) && setCm(false) && setInch(false) }}>foot</button></li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div className='text-center align-items-end text-light' style={{ backgroundColor: "rgba(18, 0, 27, 1)", marginTop: "-3rem" }}>
